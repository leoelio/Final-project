...
4. 下载 `clip_patch_pointer_kaggle_v2.pt` 与 `clip_patch_pointer_kaggle_v2.json` 到本机后，使用固定 MuJoCo 留出 `20-24/120-124/220-224/420-424` 运行 `scripts/evaluate_clip_patch_pointer.py`。
